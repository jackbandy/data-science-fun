...
| --- | --- |
| **Data Acquisition (DA).** A graduate can "proactively collect, integrate, and manage data from diverse sources while ensuring data quality, provenance, privacy, and regulatory compliance." | [3.1 Where do data come from?](03-ethics-in-obtaining-data.md#where-do-data-come-from)<br>[3.3 What "obtaining data" includes](03-ethics-in-obtaining-data.md#what-obtaining-data-includes)<br>[3.6 Maintaining Data](03-ethics-in-obtaining-data.md#maintaining-data)<br>[3.7 Example: How the Census Obtains Data](03-ethics-in-obtaining-data.md#example-how-the-census-obtains-data) |
| **Professionalism and Ethics (PE) — Data Stewardship.** A graduate can "diagnose stewardship risks (e.g., leakage, improper access) in real DS workflows and propose mitigations based on evidence." | [3.4.1 Defining Sensitive Information](03-ethics-in-obtaining-data.md#defining-sensitive-information)<br>[3.4.2 Handling Sensitive Information](03-ethics-in-obtaining-data.md#handling-sensitive-information)<br>[3.5 Risks from data triangulation](03-ethics-in-obtaining-data.md#risks-from-data-triangulation)<br>[3.8 Example: Facebook Profile](03-ethics-in-obtaining-data.md#example-facebook-profile) |
| **Research Methods and Experimental Design (RM).** A graduate can "design, conduct, document, and evaluate ethical and reproducible empirical investigations by formulating testable hypotheses." | [2.1 Where Questions Come From](02-ethics-in-asking-questions.md#where-questions-come-from)<br>[2.2.1 Presuppositions](02-ethics-in-asking-questions.md#presuppositions)<br>[2.6 Questions for your questions](02-ethics-in-asking-questions.md#questions-for-your-questions)<br>[5.4.3 Researcher Degrees of Freedom](05-ethics-in-reporting-decisions-solutions.md#researcher-degrees-of-freedom) |
...
| **Machine Learning (ML).** A graduate can "assess model performance, fairness, robustness, and interpretability" and "design scalable, ethical, and responsible machine learning solutions." | [4.1 Your Model is Always Wrong](04-ethics-in-understanding.md#your-model-is-always-wrong)<br>[4.2.2 Multiple Correct Models](04-ethics-in-understanding.md#multiple-correct-models)<br>[4.2.3 Patterns are not Laws](04-ethics-in-understanding.md#patterns-are-not-laws)<br>[4.3.4 Validity, overfitting, generalization](04-ethics-in-understanding.md#validity-overfitting-generalization) |
| **Data Storytelling (DS).** A graduate can "design, evaluate, and deliver clear, accurate, and ethically responsible data stories... tailored to diverse audiences and support informed decision-making." | [2.5 Framing and rhetoric](02-ethics-in-asking-questions.md#framing-and-rhetoric)<br>[4.3.3 Uncertainty](04-ethics-in-understanding.md#uncertainty)<br>[5.4.1 Common Knowledge](05-ethics-in-reporting-decisions-solutions.md#common-knowledge)<br>[5.4.2 Audience](05-ethics-in-reporting-decisions-solutions.md#audience) |
| **Professionalism and Ethics (PE).** A graduate can "apply ethical reasoning, legal awareness, and professional standards to the responsible acquisition, analysis, deployment, and communication of data-driven solutions, demonstrating accountability, transparency, and respect for individuals, organizations, and society." | [1.1 What is wisdom?](01-working-toward-wisdom.md#what-is-wisdom)<br>[2.3.5 Invasive questions](02-ethics-in-asking-questions.md#invasive-questions)<br>[5.1.3 Goodhart's Law](05-ethics-in-reporting-decisions-solutions.md#goodharts-law)<br>[5.4.4 Retractions and Corrections](05-ethics-in-reporting-decisions-solutions.md#retractions-and-corrections)<br>[5.4.4.2 Standards](05-ethics-in-reporting-decisions-solutions.md#standards) |
:::
