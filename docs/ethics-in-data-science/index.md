...
The data science lifecycle, slightly modified from [*Learning Data Science*](https://learningds.org/ch/01/lifecycle_cycle.html).
:::
...
|  | [Working Toward Wisdom](01-working-toward-wisdom.md) |
...
This is not the only book to discuss ethics in data science. Many of the core issues discussed in the book have been discussed elsewhere, in books and articles and essays which serve as the source material for this book, including:
...
What is intended to be unique and useful about this book is its alignment with the "data science lifecycle," which I encountered in *Learning Data Science* [@lau_learning_2023].

The lifecycle model has been a helpful way to organize the wide array of ethical questions, dilemmas, and decisions that arise in the work of the data scientist: How can data be collected responsibly? What is considered sensitive information? What makes some questions inappropriate? When and how can data be published? How does one deal with the persuasive power of data?

Before exploring the details of these questions in [Ethics in Asking Questions](02-ethics-in-asking-questions.md), [Ethics in Obtaining Data](03-ethics-in-obtaining-data.md), [Ethics in Understanding](04-ethics-in-understanding.md), and [Ethics in Reporting Decisions & Solutions](05-ethics-in-reporting-decisions-solutions.md), I have taken the liberty to include one framing chapter, [Working Toward Wisdom](01-working-toward-wisdom.md), which zooms out and asks: why are we doing any of this at all?
