...
# Week 10, Day 1 {.course-title .photo-title data-state="photo-title" background-image="../assets/orange-line-stops-better/stop11-ashland-a.jpg" background-size="cover"}
...
![](../assets/orange-line-map-stops/stop11-ashland.svg){.figure alt="Orange Line map with the Ashland stop marked, the Week 10 stop"}
...
1. GitHub source: <https://github.com/jackbandy/data-science-fun/blob/main/docs/slides/week10.qmd>.
