...
::: {.caption}
Spot a typo, a broken link, a confusing sentence? Open a pull request on the course repo. Small fixes count. Image: [GitHub Docs](https://github.com/github/docs), [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
:::
