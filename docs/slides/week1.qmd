...
## Random Draw: 12 of 62 {.iframe-slide}

<iframe src="https://www.random.org/integers/?num=12&min=1&max=62&col=2&base=10&format=html&rnd=new" title="RANDOM.ORG draw of 12 integers between 1 and 62" loading="lazy" style="border: 1px solid #999; box-shadow: 0 10px 28px rgba(0,0,0,0.12); border-radius: 3px;"></iframe>

::: {.iframe-caption}
Generated live at <https://www.random.org/integers/>
:::
...
- save these for political debates
:::
