...
- Your **worksheet** has a place for questions — ask them out loud; someone else is wondering too
...
| Weeks | Topic |
|:--|:--|
| **1** | Intro; the lifecycle; asking questions |
| **2–3** | Statistics review; Python, Polars, obtaining & wrangling data |
