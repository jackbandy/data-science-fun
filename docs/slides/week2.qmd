...
# Why Python for this Course {.smaller}
...
# Types in Python {.smaller}

Every value in Python has a type, and the type decides what you can do with it. These are the built-ins — you will  use six of them constantly
...
A list holds several values in one variable, in order. It is the most common container in Python — and the shape almost every web API hands back.
