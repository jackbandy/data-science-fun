...
# tool, which also drafted the garden-of-forking-data and statistical-opportunist
# slides. Maintained, reviewed, and vetted by humans.
...
# Two Worldviews, One Coin {.section-header}
...
## Same Data, Two Answers {.image-frame-slide}
<img src="../assets/coin-flip-worldviews/coin-flip-worldviews-flip14.svg" alt="Both estimates across all 14 flips. The frequentist line lurches early and ends at 71.4 percent; the Bayesian line moves more gradually and ends at 68.8 percent. The two flips being bet on remain empty">
...
## The Terminology, Applied to the Coin {.smaller}
...
- A bigger **event** — "10 of the 14 were heads": 1,001 paths
- **Conditional probability** — $P(\text{heads next} \mid \text{10 heads in 14})$
- **Bayes' theorem** — flips it: $P(\text{biased} \mid \text{the 14 flips})$
:::
::::
...
- **$p$-value** — how often a *fair* coin is this lopsided: $2 \times \frac{1{,}471}{16{,}384} \approx 0.18$
...
- Be able to say **why** you picked what you picked!
:::
...
# Appendix: Wide and Long Data {.section-header}
...
23. "Questions You've Done So Far" indexes the probability questions from Homeworks 1 and 2, which live in the course's PrairieLearn repository (`pl-uic-cs418`).
