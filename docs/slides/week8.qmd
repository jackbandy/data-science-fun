...
::: {}
[Week 8, Day 1]{.eyebrow}

- Linear Regression
:::

![](../assets/orange-line-map-stops/stop09-roosevelt.svg){.figure alt="Orange Line map with the Roosevelt stop marked, the Week 8 stop"}
