...
Both are statements about **A**. The prior is the start, posterior is the end.
:::
...
::: {.fragment style="font-size:0.78em; margin-top:0.3em;"}
$P(B \mid A)$ and $P(A \mid B)$ point in **opposite directions**: swapping them is the most common error with this formula. $P(B)$ is the normalizer.
:::
...
::: {.fragment style="font-size:0.9em;"}
The prior was 4%. The evidence roughly **quadrupled** it, to 15%, but nowhere near 90%. A rare $A$ stays fairly rare even after evidence that points right at it.
:::
