...
# Florence Nightingale's Mortality Diagram (1858) {.image-only data-state="image-only"}

![Florence Nightingale, "Diagram of the causes of mortality in the army in the East" (1858) — a polar area chart shown full-bleed, with only the footer overlaid](../assets/slides-misc/Nightingale-mortality.jpg)
