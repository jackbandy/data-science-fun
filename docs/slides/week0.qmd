...
<iframe src="../timer/" title="CTA-style countdown timer" loading="lazy" style="width: 100%; height: 520px; border: 1px solid #999; box-shadow: 0 10px 28px rgba(0,0,0,0.12); border-radius: 3px;"></iframe>
