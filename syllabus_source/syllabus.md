...
See the [[UIC Academic Calendar]{.underline}](https://catalog.uic.edu/ucat/academic-calendar/) for add/drop, withdrawal, and other academic deadlines.
...
If your name or pronouns do not match the class roster, please let the class know so that we can address you the way you want to be addressed. I use he/him pronouns. For more information, see: [mypronouns.org/what-and-why](https://www.mypronouns.org/what-and-why).
...
**The Math and Science Learning Center (MSLC)**, located in the Science and Engineering South Building (SES) at 845 W. Taylor St. 3rd Floor, Room 247, offers tutoring and study space for students in Math, Biological Sciences, Chemistry, Earth and Environmental Sciences, and Physics. Visit the [[MSLC website]{.underline}](https://mslc.uic.edu/), call 312-355-4900, or email [[mslc@uic.edu]{.underline}](mailto:mslc@uic.edu).

**The Academic Center for Excellence (ACE)** can help if you feel you need more individualized instruction in reading and/or writing, study skills, time management, etc. Please call (312) 413-0031 or visit the [[Academic Center for Excellence (ACE)]{.underline}](https://ace.uic.edu/) website for more information.
