---
summary: Wrangle flight data with pandas, scrape the web, and reflect on the ethics of it
...
This exercise has four parts. You will work through a set of `pandas` operations on real flight data, collect data from an API and from web pages, answer a few questions about the ethics of that kind of data collection, and document whether and how you used AI tools.
...
🔴 Part 3, the ethics questions, is yours to think through. Using a tool there defeats the point of the exercise.

The three phases are in the [syllabus](/syllabus/) and the [FAQ](/faq.html#double-red-no-aillm-based-tools).

## A note on usage counting
...
To opt out, create an empty file named `.ai-usage/opt-out` in the folder, or set `CS418_NO_AI_USAGE_LOG=1` in your environment. Opting out has no effect on your grade, and you do not have to tell anyone you did it.
