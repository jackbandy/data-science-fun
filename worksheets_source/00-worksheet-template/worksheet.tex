% CS 418: Intro to Data Science — Worksheet Template
% Usage: copy this folder, rename it (e.g. 01-topic-name), edit below.
...
\begin{minipage}[t]{0.55\textwidth}
  \vspace{0pt}
  {\LARGE \textbf{Worksheet \#\,0}} \\[0.3em]
  {\large \textit{Topic Title Here}}
\end{minipage}
\hfill
...
% ── Course information (fill-in-the-blank) ─────────────────────────────────────

\noindent\textbf{Key Course Objectives:}
...
\begin{problem}{2}
  Problem statement goes here. Parts can use \texttt{enumerate}:
